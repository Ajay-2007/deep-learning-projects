...
# boundries for ADABOOST parameters:
# 'n_estimators': 1..100
...
# define the hyperparameters attributes individually
...
# create the individual creator to fill up an Individual instance:
...
def main():
    ...
    print('params = ', test.format_params(hof.items[0]))
